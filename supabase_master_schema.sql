...
-- Seed Editorial Banners (Photos réelles issues du shooting officiel MG Perfume)
INSERT INTO public.editorial_banners (id, tag, title, image, alt, link_text, href, bg_color, object_position, display_order)
VALUES
  ('naimez-que-moi', 'Senteurs d’Orient', 'ÉLIXIRS & GOUTTES INTIMES', '/images/shooting/naimez-que-moi-model.jpg', 'Mannequin tenant l élixir N Aimez Que Moi MG Perfume', 'Découvrir la Collection Intime', '/boutique?family=oriental', '#0E2A1A', 'center top', 1),
  ('rose-desir', 'Élixirs du Moment', 'FRAGRANCES FÉMININES', '/images/shooting/rose-desir-model.jpg', 'Shooting Rose Désir MG Perfume', 'Explorer les créations', '/boutique', '#350B14', 'center center', 2),
  ('un-amour', 'Le Geste & Le Sillage', 'L’ART DU VAPORISATEUR', '/images/shooting/un-amour-spray.jpg', 'Vaporisation Parfum Un Amour MG Perfume', 'Voir la boutique', '/boutique', '#250810', 'center center', 3),
  ('gamme-gouttes', 'Rituel de Layering', 'HUILES & MUSCS INTENSES', '/images/shooting/gamme-gouttes.jpg', 'Podium Huiles et Muscs MG Perfume', 'Découvrir les muscs', '/boutique', '#0E1E38', 'center center', 4)
ON CONFLICT (id) DO UPDATE SET
  tag = EXCLUDED.tag,
...
-- Seed Initial Products (Photos réelles du catalogue public/images/products)
...
VALUES
  ...
  (
    ...
    'Seasons Drift',
    'Z / Aoud',
    'Sillage boisé noble aux accents de poivre rose et résine d’ambre',
    25000,
    NULL,
    '100 ml',
    '/images/products/seasons-drift.jpg',
    'boise',
    'Boisé Aromatique',
    NULL,
    ARRAY['Zeste de citron', 'Poivre rose', 'Pamplemousse'],
    ARRAY['Sauge clarée', 'Gingembre', 'Cèdre'],
    ARRAY['Labdanum', 'Bois de santal', 'Ambre précieux', 'Résine'],
    'Un parfum d’une tenue remarquable avec une fraîcheur d’agrumes poivrée qui s’ancre dans un lit de santal et d’ambre profond.',
    false,
    false,
    true
  ),
  (
    ...
    'Mazaaj Infused',
    'Z / Aoud',
    'Fraîcheur vive d’agrumes infusée d’oliban et d’ambroxan',
    25000,
    NULL,
    '100 ml',
    '/images/products/mazaaj-infused.jpg',
    'aquatique',
    'Hespéridé & Boisé',
    NULL,
    ARRAY['Citron', 'Orange', 'Bergamote'],
    ARRAY['Néroli', 'Gingembre frais'],
    ARRAY['Oliban', 'Ambroxan', 'Notes boisées nobles'],
    'L’accord idéal entre dynamisme solaire et profondeur mystique. Une explosion hespéridée équilibrée par l’encens oliban.',
    false,
    false,
    true
  ),
  (
    ...
    'Raheeq',
    'Nusuk',
    'Gourmandise miellée, abricot velouté et magnolia précieux',
    25000,
    30000,
    '100 ml',
    '/images/products/raheeq.jpg',
    'gourmand',
    'Gourmand Solaire',
    'Coup de Cœur',
    ARRAY['Citron', 'Miel doré', 'Orange sanguine', 'Abricot'],
    ARRAY['Caramel fondant', 'Noix de coco', 'Magnolia'],
    ARRAY['Vanille absolue', 'Bois de santal', 'Musc blanc'],
    'Un hymne à la douceur et à l’opulence. Des effluves de miel et d’abricot fondant sur un cœur de caramel vanillé et de magnolia.',
    true,
    false,
    true
  ),
  (
    ...
    'Souvenir Blooming Bliss',
    'Afnan',
    'Dôme d’élégance, noix de coco crémeuse et bois de Palo Santo',
    30000,
    NULL,
    '100 ml',
    '/images/products/souvenir-blooming-bliss.jpg',
    'gourmand',
    'Boisé Gourmand',
    NULL,
    ARRAY['Vanille bourbon'],
    ARRAY['Noix de coco lactée', 'Caramel', 'Palo Santo'],
    ARRAY['Bois de santal', 'Musc blanc pur'],
    'Présenté dans son flacon sphérique d’exception, Blooming Bliss libère une aura crémeuse et mystique avec les nuances du Palo Santo.',
    false,
    false,
    true
  ),
  (
    ...
    'Mystique Bouquet',
    'Afnan',
    'Brassée somptueuse de fleurs d’oranger, pêche blanche et litchi',
    30000,
    NULL,
    '100 ml',
    '/images/products/mystique-bouquet.jpg',
    'floral',
    'Floral Fruitier Boisé',
    'Tendance',
    ARRAY['Bergamote', 'Pêche blanche', 'Mandarine'],
    ARRAY['Fleur d’oranger', 'Vétiver', 'Mahonia'],
    ARRAY['Ambroxan', 'Vanille', 'Musc doux'],
    'Un bouquet floral envoûtant et moderne où la pêche blanche et la fleur d’oranger s’épanouissent sur un lit de vanille et d’ambroxan.',
    true,
    false,
    true
  )
